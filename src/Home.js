      ...
      <div className="mid-container">
        ...
        <div className='mr-container'>
          ...
          <form >
            ...
            <br /><br></br>
            <Link to={'/Response'}><button className="btn1" type="submit">Search Now</button></Link>
            <br /><br /><Link to={'/Shopaddpage'}><button className="btn1" type="submit">Add Shop</button></Link>
          </form>
        </div>
      </div>
      <br />
